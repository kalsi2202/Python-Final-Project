...
def pdf_maker(month):
    ...
    <thead><tr><th width="55%">&nbsp;</th><th width="45%">&nbsp;</th><th width="25%">&nbsp;</th><th width="55%">&nbsp;</th></tr></thead>
    <tbody>
    ...
    <br>
    <p><i> Employee Signature {info[1]}(Date of print: {str(datetime.datetime.now())}) </i></p>
    """
...
def personal_page_setup(personal_page):
    ...
    Label(personal_page, text="Father: ", bg="light blue", width=20, height=2).grid(row=2, column=0)
